...
**DBpia**는 대한민국 최고의 학술 논문 검색 및 접근 플랫폼입니다.  
인문학, 사회과학, 공학 등 다양한 분야의 학술지와 연구 자료를 제공합니다.  
주로 대학과 연구 기관에서 구독하며 PDF 전문 접근을 제공합니다.  
DBpia는 신뢰할 수 있는 연구 자료를 찾기 위해 가장 널리 사용되는 학술 데이터베이스입니다.
...
- **DBpia 서비스 운영 유지** – Excel 다운로드 버그 수정, PDF 다운로드 서버 관리, 장기 미사용 사용자 처리
...
**DCMaker**는 DBpia에서 제공하는 연구 논문의 메타데이터를 입력하는 플랫폼입니다.  
원래 C++와 C#을 사용하여 개발된 시스템을 차세대 웹 기반 재설계를 통해 현대화했습니다.

#### 프로젝트 상세

##### 시스템 아키텍처 및 인프라

- C#과 C++로 작성된 **레거시 소스 코드를 분석**하고 새로운 웹 기반 시스템 설계
...
- XSS, CSRF 및 민감한 데이터 마스킹을 포함한 **침투 테스트 문제 처리**
- SQL Server의 Linked Server를 활용하여 다른 위치에서 **저장 프로시저를 원격으로 호출**

##### 연구 논문 메타데이터 생성 시스템 개발

- PDFBox를 사용하여 **PDF 분할 알고리즘 개발**, PDF의 논리적 페이지와 물리적 페이지 간 차별화 보장
